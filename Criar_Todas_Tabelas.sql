...
BEGIN
    CREATE TABLE contratos (
        ...
        id_cliente INT NOT NULL,
        tipo_cobranca VARCHAR(20) CHECK (tipo_cobranca IN ('Chamado', 'Hora T�cnica', 'Mensal')) NOT NULL, 
...
ELSE
BEGIN
    PRINT 'A tabela contratos j� existe!';
END


-- Criando tabela avalia��es
IF NOT EXISTS (
    SELECT 1 FROM sys.tables 
...
ELSE
BEGIN
    PRINT 'A tabela relatorios j� existe!';
END;
...
ELSE
BEGIN
    PRINT 'A tabela logs_acesso j� existe!';
END;
